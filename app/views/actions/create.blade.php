...
<div class='container'>
    ...
    <div class='panel'>
{{ Form::open(array('action' => 'ActionController@postAction', 'method' => 'post', 'id' => 'frm-add-action', 'class'=>'navbar-form navbar-left'))}}
...
<script>
    $("document").ready(function ($) {
        ...
        $('#frm-add-action').on('submit', function (e) {
            ...
            var action = "{{ URL::action('ActionController@postAction')}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    $('#frm-add-action').trigger("reset");
                    document.getElementById('busy-icon').innerHTML="Save Complete. Enter new Action.";
                }
            }, 'json');
            return false;
        });
